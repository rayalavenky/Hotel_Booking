      ...
      <Container className='mb-2'>
        ...
        <Row>
          <h4 className='text-center'>
            Services at our<span className='hotel-color'> Hotel </span>
        ...
        <Row xs={1} md={2} lg={3} className='g-4 mt-2'>
          ...
          <Card>
            <Card.Body>
              ...
              <Card.Text>Stay your day with a delicious breakfast buffet.</Card.Text>
            </Card.Body>
          </Card>
          </Col>
          ...
          <Card>
            <Card.Body>
              ...
              <Card.Text>Enjoy a refreshing drink or snack from our mini-bar service.</Card.Text>
            </Card.Body>
          </Card>
          </Col>
